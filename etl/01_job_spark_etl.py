...
#Modificando os nomes das colunas, trocando espaços por “_”, retirando acentos e colocando todas as letras minúsculas
rais = (
    rais
...
#Modificando as colunas de remuneração para que sejam do tipo double
rais = (
    rais
